...
void SimpleController::velCallback(const geometry_msgs::msg::TwistStamped &msg){
    ...
    Eigen::Vector2d wheel_speeds = speed_conversion_.inverse() * robot_speed;

    std_msgs::msg::Float64MultiArray wheel_speed_msg;
    wheel_speed_msg.data.push_back(wheel_speeds.coeff(1));
    wheel_speed_msg.data.push_back(wheel_speeds.coeff(0));
